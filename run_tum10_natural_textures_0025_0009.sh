...
copy_texture "$DTD_ROOT/stained/stained_0025.jpg" "$TEXTURE_ROOT/dtd_stained_0025_texture.jpg"
copy_texture "$DTD_ROOT/blotchy/blotchy_0009.jpg" "$TEXTURE_ROOT/dtd_blotchy_0009_texture.jpg"
...
run_one() {
  ...
  SURFACE_COVERAGE_MIN=0.005 \
  SURFACE_COVERAGE_MAX=0.05 \
  SURFACE_MIN_VISIBLE_FRAMES=4 \
  SURFACE_MIN_VISIBILITY_RATIO=0.5 \
  ...
  SURFACE_MIN_SUPPORT_RATIO=0.55 \
  PHYSICAL_EOT=1 \
  TV_WEIGHT=0.005 \
...
run_one dtd_stained_0025 "$TEXTURE_ROOT/dtd_stained_0025_texture.jpg"
run_one dtd_blotchy_0009 "$TEXTURE_ROOT/dtd_blotchy_0009_texture.jpg"

echo "===== done natural texture 0025 and 0009 ====="
