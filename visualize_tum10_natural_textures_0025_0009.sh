...
OUT_BASE="${OUT_BASE:-$BASE/natural_texture_visualizations}"
...
visualize_one tum10_sitting_static_wall_pose_gt_dtd_stained_0025_natural_lr002_ref005
visualize_one tum10_sitting_static_wall_pose_gt_dtd_blotchy_0009_natural_lr002_ref005
