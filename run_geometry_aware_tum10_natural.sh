...
export SURFACE_SUPPORT_CHECK="${SURFACE_SUPPORT_CHECK:-1}"
export SURFACE_SUPPORT_ABS_TOLERANCE="${SURFACE_SUPPORT_ABS_TOLERANCE:-0.08}"
export SURFACE_SUPPORT_REL_TOLERANCE="${SURFACE_SUPPORT_REL_TOLERANCE:-0.05}"
export SURFACE_MIN_SUPPORT_RATIO="${SURFACE_MIN_SUPPORT_RATIO:-0.6}"
...
export NATURAL_AUTO_RELAX="${NATURAL_AUTO_RELAX:-1}"
export NATURAL_RELAX_MAX_COVERAGE="${NATURAL_RELAX_MAX_COVERAGE:-0.08}"
export NATURAL_RELAX_MIN_VISIBLE_FRAMES="${NATURAL_RELAX_MIN_VISIBLE_FRAMES:-2}"
export NATURAL_RELAX_MIN_VISIBILITY_RATIO="${NATURAL_RELAX_MIN_VISIBILITY_RATIO:-0.25}"
export NATURAL_RELAX_ORIENTATION_FILTER="${NATURAL_RELAX_ORIENTATION_FILTER:-fronto_or_tabletop}"
export NATURAL_RELAX_MAX_TILT_DEGREES="${NATURAL_RELAX_MAX_TILT_DEGREES:-50}"
export NATURAL_RELAX_MIN_CENTER_DEPTH="${NATURAL_RELAX_MIN_CENTER_DEPTH:-1.0}"
export NATURAL_RELAX_MIN_SUPPORT_RATIO="${NATURAL_RELAX_MIN_SUPPORT_RATIO:-0.3}"
